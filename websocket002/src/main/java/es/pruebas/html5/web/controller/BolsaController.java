...
import es.pruebas.html5.websocket.BolsaEndpoint;
...
public class BolsaController {
	...
	public ModelAndView gestionarMercadosActualizarAccion(@ModelAttribute("accionForm") AccionForm accionForm) {
		...
		serverMessage.setCodigo("999");
		serverMessage.setAcciones(bolsaService.getAcciones());
		BolsaEndpoint.enviarMensaje(serverMessage);
